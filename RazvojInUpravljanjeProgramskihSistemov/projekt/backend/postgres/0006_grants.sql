...
revoke all on function sistemi_private.register_social_media_user(text, text, text) FROM PUBLIC;
...
grant execute on function sistemi_private.register_social_media_user(text, text, text) to sistemi_anonymous;